...
//we're gonna make our aplication so that we can test locally and also try it on a testnet.
//we're gonna make it network agnostic so that the frontend works exactly the same, independent of what network we're on
